...
public class SortingTest {
	...
	private static int[] DoQuickSort(int[] value) {
		DoIterativeQsort(value);
		//DoRecursiveQSort(value, 0, value.length - 1);
		return (value);
	}
	public static void DoIterativeQsort(int[] arr) {
		//Modification from http://stackoverflow.com/questions/12553238/quicksort-iterative-or-recursive
		//원본 코드와 달리, 피벗을 첫 원소로 잡았고, 파티션메소드를 따로 지정하지 않았으며, end변수를 last변수로 바꿈에 따라 그 기능을 달리하였다.
